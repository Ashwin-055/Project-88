...
export default class PostCard extends Component {
  ...
  likeAction = () => {
    ...
    if (this.state.is_liked===false) {
      updates['/posts/' + this.props.post.key + '/likes'] =
        (this.state.likes+1);
      this.setState({is_liked:"null",likes:this.state.likes+1});
    } else if (this.state.is_liked==="null") {
      updates['/posts/' + this.props.post.key + '/likes'] =
        (this.state.likes-1);
    ...
    firebase
      ...
      .on('value', (snapshot) => {
        ...
        this.setState({
          ...
          likes: this.state.post_data.likes,
        });
      });
  };
